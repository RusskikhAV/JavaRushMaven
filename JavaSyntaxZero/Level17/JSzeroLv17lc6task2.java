...
Фильтруем выходные
*/
public class JSzeroLv17lc6task2 {
    ...
    public static boolean isWeekend(LocalDateTime dateTime) {
        ...
        var minutes = dateTime.getMinute();
        System.out.println(day);
        if (day.equals(DayOfWeek.FRIDAY) && hour >= WEEKEND_START_FRIDAY_CUT_OFF_HOUR) {
            return true;
        } else if (day.equals(DayOfWeek.SATURDAY)) {
            return true;
        } else if (day.equals(DayOfWeek.SUNDAY) && hour < WEEKEND_END_SUNDAY_CUT_OFF_HOUR) {
            return true;
        }
