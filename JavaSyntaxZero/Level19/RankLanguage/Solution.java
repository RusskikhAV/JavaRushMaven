package JavaSyntaxZero.Level19.RankLanguage;
...
public class Solution {
    ...
    public static Stream<Language> sortByRanking(ArrayList<Language> languages) {
        Stream<Language> languageStream = languages.stream().sorted(Comparator.comparingDouble(Language::getRanking).reversed());
