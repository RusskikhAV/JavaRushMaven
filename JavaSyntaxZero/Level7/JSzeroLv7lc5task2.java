...
Города гиганты
 */
public class JSzeroLv7lc5task2 {
    ...
    public static void printCityPopulation(String city, double population) {
        ...
        System.out.println("В то время как в самом густонаселенном городе " + JSzeroLv7lc5task2.city + " население составляет " + JSzeroLv7lc5task2.population + " млн человек.");
    }
}
